...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.buspilotCalendar = new FullCalendar.Calendar(e, {
    timeZone: "local",
    editable: !0,
    droppable: !0,
    selectable: !0,
    ...
    windowResize: function (e) {
      var t = r();
      window.buspilotCalendar.changeView(t);
    },
    ...
    eventClick: function (e) {
      ...
      var e = v.start,
        ...
        a = null,
        d =
          (null != n && (a = (d = new Date(n)).setDate(d.getDate() - 1)),
        ...
        : (v
            ? (v.setProp("id", s),
              ...
              y[t] &&
                ...
                (y[t].location = r)),
              window.buspilotCalendar.render())
            : (window.buspilotCalendar.addEvent(
                (n = {
                  id: u,
                  title: e,
                  start: d,
